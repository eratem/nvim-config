...
return {
	...
	remap("n", "<leader>y", [["+y]], { desc = 'yank to system clipboard' }),
	remap("v", "<leader>y", [["+y]], { desc = 'yank to system clipboard' }),
	remap("n", "<leader>Y", [["+Y]], { desc = 'yank till end of line to system clipboard' }),
